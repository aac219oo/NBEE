...
import { AILoadingBar, AIMenu } from "@heiso/core/components/ui/ai-menu";
import { AIAnchorElement, AILeaf } from "@heiso/core/components/ui/ai-node";
        ...
        if (isFirst && mode === "insert") {
          ...
          editor.tf.withoutSaving(() => {
            editor.tf.insertNodes(
              ...
              {
                at: PathApi.next(focusPath.slice(0, 1)),
              },
            );
          });
